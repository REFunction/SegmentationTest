...
if __name__ == '__main__':
    import time
    coco2014 = COCO2014('H:/COCO/new/val2014/images/', 'H:/COCO/new/val2014/annotations/')
    coco2014.start_batch_queue(8)
    time.sleep(5)
    for i in range(10000):
        start_time = time.time()
        coco2014.get_batch_fast(8)
        print(coco2014.batch_queue.qsize(), time.time() - start_time)